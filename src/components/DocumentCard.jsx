...
export default function DocumentCard({ document, categories }) {
  ...
  return (
    <Link
      ...
      className="group bg-card rounded-xl border p-4 hover:shadow-lg hover:border-primary/20 transition-all duration-300 block"
    >
