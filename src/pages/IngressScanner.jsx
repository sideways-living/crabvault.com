...
import {
  ...
  Loader2, FolderSearch, ExternalLink
} from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 space-y-2 text-sm text-blue-900">
        ...
        <ol className="list-decimal ml-5 space-y-1 text-blue-800 text-xs">
          ...
          <li>Run <code className="bg-white px-1 rounded border border-blue-200">node watcher/scan-ingress.js</code> to scan only</li>
          <li>Run <code className="bg-white px-1 rounded border border-blue-200">node watcher/scan-ingress.js --upload</code> to scan <strong>and automatically upload missing files</strong></li>
          <li>Click <strong>Refresh</strong> above to see updated results</li>
        </ol>
      </div>
